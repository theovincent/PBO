    ...
    do 
        ...
        do
            ...
            do 
                ...
                PARAMS=$(jq '.replay_buffer_size = $REPLAY_BUFFER_SIZE' --argjson REPLAY_BUFFER_SIZE $REPLAY_BUFFER_SIZE experiments/lunar_lander/parameters.json)
                ...
                launch_job/lunar_lander/launch_dqn.sh -e $EXPERIMENT_NAME -fs 1 -ls 1
            done
        done
    done
done