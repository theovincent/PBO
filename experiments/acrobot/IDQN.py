...
def run_cli(argvs=sys.argv[1:]):
    ...
    parser = argparse.ArgumentParser("Train IDQN on Acrobot.")
    addparse(parser, seed=True)
    args = parser.parse_args(argvs)
    print_info(args.experiment_name, "IDQN", "Acrobot", args.max_bellman_iterations, args.seed)
    ...
    train("acrobot", args, q, p, exploration_key, sample_key, replay_buffer, collect_samples_multi_head, env)
