...
def run_cli(argvs=sys.argv[1:]):
    ...
    q_random = define_q(p["n_states"], env.n_actions, p["gamma"], jax.random.PRNGKey(0), zero_initializer=False)
    # Add random weights
    ...
    train("chain_walk", args, q, p, pbo_network_key, data_loader_samples, data_loader_weights, env.n_actions)
